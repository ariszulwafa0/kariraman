...
const modelPro = genAI.getGenerativeModel({ model: "gemini-2.5-pro", safetySettings });
const modelVision = genAI.getGenerativeModel({ model: "gemini-2.5-pro", safetySettings });
